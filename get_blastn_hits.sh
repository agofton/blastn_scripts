...
for file3 in ${input_dir}/.fasta
  do
    usearch9.2 -fastx_getseqs ${file3} -labels "${ids_dir}/$(basename "$file3" .fasta)_blastout_seqids.txt" -fastaout "${blast_fasta_out_dir}/$(basename "$file3" .fasta)_blastout.fasta"
done
